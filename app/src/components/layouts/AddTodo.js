...
const AddTodo = () => {
    ...
    return (
        ...
        <Modal overflow={true} show={show} onHide={() => setShow(false)} size="xs">
            <Modal.Header>
            ...
            >   
                {/* priority */}
                <FormGroup>
                <RadioGroup onChange={(value)=> setPriority(value)} name="priority" inline appearance="picker">
                ...
                {/* completed */}
                <FormGroup> 
                <Toggle onChange={(checked)=>setCompleted(checked)} size="lg" checkedChildren="completed" unCheckedChildren="   due   " />
                </FormGroup>
